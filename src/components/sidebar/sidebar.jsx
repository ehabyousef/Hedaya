      ...
      <div className="d-flex flex-column gap-5 my-5 align-items-start ps-3 ps-lg-5">
        <Link to={"/dashboard/dash_prdoucts"}>
          <div
            ...
            className={`d-flex gap-3 align-items-center ${style.title_div}  ${choosen === "Prdoucts" ? style.active : ""
              }`}
          >
        ...
        <Link to={"/dashboard/add"}>
          <div
            ...
            className={`d-flex gap-3 align-items-center ${style.title_div}  ${choosen === "Add" ? style.active : ""
              }`}
          >
