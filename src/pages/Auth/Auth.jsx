...
export default function Auth(props) {
    ...
    return (
        <>
            <div className="container d-flex justify-content-center align-items-center " style={{ height: "85vh", width: '100vw' }}>
                <div className="d-flex overflow-hidden position-relative shadow rounded-5 p-0" style={{ height: '80vh', width: '80vw' }}>
                    ...
                    <div id={style.menu} className={`col-12 col-md-6 d-flex justify-content-center align-items-center flex-column gap-3 ${menuClicked ? style.menuClicked : ''}`}>
                        <h1>Hello, friend</h1>
                    ...
                    <div id={style.menu2} className={`col-12 col-md-6 d-flex justify-content-center align-items-center flex-column gap-3 ${menuClicked2 ? style.menuClicked2 : ''}`}>
