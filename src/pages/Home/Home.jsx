    ...
    <div className="container">
      ...
      >
        <SwiperSlide className={style.swiper_slide}>
          ...
          >
            <Link to={"/allProducts"} className={style.text}>
              Shop now
            </Link>
            <span className={style.circle}></span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={style.arr_1}
              viewBox="0 0 24 24"
            >
        ...
        <SwiperSlide className={style.swiper_slide}>
          <motion.h1
            ...
            style={{ color: "white" }}
          >
            Books and islamic acccessories
          </motion.h1>
          <motion.button
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <div className="row my-4">
        <div className="col-12 col-lg-8 d-flex flex-column gap-3">
          <div className="d-flex gap-2 align-items-center">
            <div
              className="d-flex w-100 flex-column gap-3 justify-content-end align-items-start"
              id={style.first_card}
            >
            ...
            <div
              className="d-flex w-100 h-100 flex-column gap-3 justify-content-end align-items-start"
              id={style.sec_card}
            >
              <p className="m-0">new arrival</p>
          ...
          <div className="d">
            <div
              className="d-flex flex-column gap-3 justify-content-end align-items-start"
              id={style.third_card}
            >
              <p className="m-0">new arrival</p>
              <h3>Hijab & negab</h3>
        ...
        <div className="col-4 d-none d-lg-block">
          <div
            className="d-flex h-100 flex-column gap-3 justify-content-end align-items-start"
            id={style.fourth_card}
          >
            <p className="m-0">new arrival</p>
